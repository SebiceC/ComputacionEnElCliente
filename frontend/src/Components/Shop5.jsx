...
import producto1 from '../img/cocacola.webp';
import producto2 from '../img/Detoditos.png';
import producto3 from '../img/leche.webp';
import producto4 from '../img/torta.webp';
...
<div>
    ...
    <div className="container-fluid">
      ...
      <div className="col-12">
          ...
          <Link className="breadcrumb-item text-dark text-decoration-none" to="/">
            ...
            <span className="breadcrumb-item active">Alimentos</span>
          </nav>
          {/* Breadcrumb End */}
        </div>
  ...
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <Link to='/ProductDetail5'> <img className="img-fluid" src={producto1} alt="" style={{ maxWidth: '80%', maxHeight: '60%', display: 'inline-block' }} /></Link>
    </div>
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Coca-Cola 3L</h5>
...
<div className="col-lg-6 col-md-6 col-sm-6 pb-3">
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">De Toditos</h5>
      <div className="d-flex align-items-center justify-content-center mt-3">
        <h5>$8.500</h5>
      </div>
      <div className="d-flex align-items-center justify-content-center mt-3">
...
<div className="col-lg-6 col-md-6 col-sm-6 pb-3">
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Leche Alpina</h5>
      <div className="d-flex align-items-center justify-content-center mt-3">
        <h5>$5.000</h5>
      </div>
      <div className="d-flex align-items-center justify-content-center mt-3">
...
<div className="col-lg-6 col-md-6 col-sm-6 pb-3">
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Torta Jet</h5>
      <div className="d-flex align-items-center justify-content-center mt-3">
        <h5>$12.000</h5>
      </div>
      <div className="d-flex align-items-center justify-content-center mt-3">
