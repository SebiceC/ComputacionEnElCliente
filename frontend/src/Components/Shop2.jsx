...
import producto2 from '../img/reloj1.jpg';
import producto3 from '../img/retratos1.jpg';
import producto4 from '../img/sofa1.jpg';
...
<div>
  ...
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <Link to='/ProductDetail2'> <img className="img-fluid" src={producto1} alt="" style={{ maxWidth: '80%', maxHeight: '60%', display: 'inline-block' }} /></Link>
    </div>
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Aromatizante</h5>
...
<div className="col-lg-6 col-md-6 col-sm-6 pb-3">
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Reloj De Pared</h5>
      <div className="d-flex align-items-center justify-content-center mt-3">
        <h5>$123.00</h5>
      </div>
      <div className="d-flex align-items-center justify-content-center mt-3">
...
<div className="col-lg-6 col-md-6 col-sm-6 pb-3">
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Portaretrato</h5>
      <div className="d-flex align-items-center justify-content-center mt-3">
        <h5>$123.00</h5>
      </div>
      <div className="d-flex align-items-center justify-content-center mt-3">
...
<div className="col-lg-6 col-md-6 col-sm-6 pb-3">
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Sofá</h5>
      <div className="d-flex align-items-center justify-content-center mt-3">
        <h5>$123.00</h5>
      </div>
      <div className="d-flex align-items-center justify-content-center mt-3">
