...
import producto1 from '../img/cepillo1.jpg';
import producto2 from '../img/limpido.jpg';
import producto3 from '../img/jabon1.jpg';
import producto4 from '../img/escoba4.jpg';
...
<div>
    ...
    <div className="container-fluid">
      ...
      <div className="col-12">
          ...
          <Link className="breadcrumb-item text-dark text-decoration-none" to="/">
            ...
            <span className="breadcrumb-item active">Limpieza</span>
          </nav>
          {/* Breadcrumb End */}
        </div>
  ...
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <Link to='/ProductDetail3'> <img className="img-fluid" src={producto1} alt="" style={{ maxWidth: '80%', maxHeight: '60%', display: 'inline-block' }} /></Link>
    </div>
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Cepillo-loco</h5>
...
<div className="col-lg-6 col-md-6 col-sm-6 pb-3">
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Limpido</h5>
      <div className="d-flex align-items-center justify-content-center mt-3">
        <h5>$12.000</h5>
      </div>
      <div className="d-flex align-items-center justify-content-center mt-3">
...
<div className="col-lg-6 col-md-6 col-sm-6 pb-3">
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Detergente</h5>
      <div className="d-flex align-items-center justify-content-center mt-3">
        <h5>$27.000</h5>
      </div>
      <div className="d-flex align-items-center justify-content-center mt-3">
...
<div className="col-lg-6 col-md-6 col-sm-6 pb-3">
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Escoba</h5>
      <div className="d-flex align-items-center justify-content-center mt-3">
        <h5>$5.000</h5>
      </div>
      <div className="d-flex align-items-center justify-content-center mt-3">
