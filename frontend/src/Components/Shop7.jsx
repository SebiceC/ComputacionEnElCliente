...
<div>
    ...
    <div className="container-fluid">
      ...
      <div className="col-12">
          ...
          <Link className="breadcrumb-item text-dark text-decoration-none" to="/">
            ...
            <span className="breadcrumb-item active">Oficina</span>
          </nav>
          {/* Breadcrumb End */}
        </div>
  ...
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <Link to='/ProductDetail7'> <img className="img-fluid" src={producto1} alt="" style={{ maxWidth: '80%', maxHeight: '60%', display: 'inline-block' }} /></Link>
    </div>
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Lampara-X</h5>
...
<div className="col-lg-6 col-md-6 col-sm-6 pb-3">
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Impresora Hp</h5>
      <div className="d-flex align-items-center justify-content-center mt-3">
        <h5>$329.900</h5>
      </div>
      <div className="d-flex align-items-center justify-content-center mt-3">
...
<div className="col-lg-6 col-md-6 col-sm-6 pb-3">
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Kit-Lapiceros</h5>
      <div className="d-flex align-items-center justify-content-center mt-3">
        <h5>$17.000</h5>
      </div>
      <div className="d-flex align-items-center justify-content-center mt-3">
...
<div className="col-lg-6 col-md-6 col-sm-6 pb-3">
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Computador Compulago</h5>
      <div className="d-flex align-items-center justify-content-center mt-3">
        <h5>$5.000.000</h5>
      </div>
      <div className="d-flex align-items-center justify-content-center mt-3">
