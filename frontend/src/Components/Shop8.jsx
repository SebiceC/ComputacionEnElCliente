...
import producto1 from '../img/biberon2.jpg';
import producto2 from '../img/pañitos1.jpg';
import producto3 from '../img/juguete1.jpg';
import producto4 from '../img/ropabebe2.jpg';
...
<div>
    ...
    <div className="container-fluid">
      ...
      <div className="col-12">
          ...
          <Link className="breadcrumb-item text-dark text-decoration-none" to="/">
            ...
            <span className="breadcrumb-item active">Para tus hijos</span>
          </nav>
          {/* Breadcrumb End */}
        </div>
  ...
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <Link to='/ProductDetail8'> <img className="img-fluid" src={producto1} alt="" style={{ maxWidth: '80%', maxHeight: '60%', display: 'inline-block' }} /></Link>
    </div>
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Biberon</h5>
...
<div className="col-lg-6 col-md-6 col-sm-6 pb-3">
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Pañitos Humedos</h5>
      <div className="d-flex align-items-center justify-content-center mt-3">
        <h5>$14.000</h5>
      </div>
      <div className="d-flex align-items-center justify-content-center mt-3">
...
<div className="col-lg-6 col-md-6 col-sm-6 pb-3">
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Juguete</h5>
      <div className="d-flex align-items-center justify-content-center mt-3">
        <h5>$30.000</h5>
      </div>
      <div className="d-flex align-items-center justify-content-center mt-3">
...
<div className="col-lg-6 col-md-6 col-sm-6 pb-3">
  <div className="product-item bg-light mb-4" style={{ width: '100%', height: '95%' }}>
    ...
    <div className="text-center py-4">
      <h5 className="h5 text-truncate">Conjuntos Bebé</h5>
      <div className="d-flex align-items-center justify-content-center mt-3">
        <h5>$55.000</h5>
      </div>
      <div className="d-flex align-items-center justify-content-center mt-3">
