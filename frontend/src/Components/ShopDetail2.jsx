...
import producto2 from '../img/aromaatizante2.webp';
import producto3 from '../img/aromatizante3.jpg';
import producto4 from '../img/aromatizante4.jpg';
import producto5 from '../img/cepillo1.jpg';
import producto6 from '../img/reloj1.jpg';
import producto7 from '../img/retratos1.jpg';
import producto8 from '../img/sofa1.jpg';
            ...
            <div className="col-lg-7 mt-5">
              <div className="card">
                <div className="card-body">
                  <h1 className="h2">Aromatizante</h1>
                  <p className="h3 py-2">$6.000</p>
                  <p className="py-2">
